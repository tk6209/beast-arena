...
const STEPS: TutorialStep[] = [
  {
    title: "BEM-VINDO À ARENA! 🏟️",
    text: "Você controla um monstro em batalhas de cartas. Reduza o HP do adversário a zero para vencer!",
    emoji: "🏟️",
    position: "center",
  },
  {
    title: "BARRAS DE VIDA 💚",
    text: "HP em cima = adversário. HP em baixo = você. Quando chegar a zero, a batalha acaba.",
    emoji: "💚",
  ...
  {
    title: "ENERGIA ⚡",
    text: "Cada carta custa energia (1, 2 ou 3 ⚡). Você regenera 3 por turno. Planeje bem!",
    emoji: "⚡",
    position: "center",
  },
  {
    title: "TIPOS DE CARTA 🃏",
    text: "⚔️ Ataque = causa dano  🛡️ Defesa = protege  💖 Cura = recupera HP  ✨ Evolução = fortalece. Segure a carta para ver detalhes!",
    emoji: "🃏",
  ...
  {
    title: "COMO JOGAR ⚡",
    text: "1. Toque uma carta para selecionar  2. Toque JOGAR  3. Passe o turno quando não tiver energia ou boa carta.",
    emoji: "⚡",
  ...
  {
    title: "COMBO SECRETO 💥",
    text: "Selecione 2 cartas do mesmo tipo (ex: 2 ataques) e aparece o botão COMBO — causa +50% de efeito!",
    emoji: "💥",
    position: "center",
  },
  {
    title: "O TIMER ⏱️",
    text: "Você tem 30 segundos por turno. Se o tempo acabar, o turno passa automaticamente!",
    emoji: "⏱️",
    targetAttr: "data-tutorial-timer",
    position: "center",
  },
  {
    title: "VENÇA E GANHE CARTAS! 🎴",
    text: "Cada vitória garante uma carta nova para sua coleção. Monte seu deck e torne-se mais forte!",
    emoji: "🏆",
    position: "center",
  },
];
